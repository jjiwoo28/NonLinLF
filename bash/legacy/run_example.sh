...
test_day="240719_new_wire_d4w256"
depth="4"
width="256"
epoch="300"
...
for dataset in "${datasets[@]}"; do
    ...
    python wire_lf_new.py --data_dir "${stanford_path}/${dataset}" --exp_dir "${result_path}/${test_day}_${dataset}" --depth $depth --width $width --whole_epoch $epoch --test_freq 5 --nonlin wire
