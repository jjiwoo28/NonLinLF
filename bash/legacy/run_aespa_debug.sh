...
test_day="240817_debug_wire_2f2w256_2"
depth="2"
width="256"
epoch="300"
...
for dataset in "${datasets[@]}"; do
    ...
    python nlf_decompose.py --data_dir "${stanford_path}/${dataset}" --exp_dir "${result_path}/${test_day}_${dataset}" --depth $depth --width $width --whole_epoch $epoch --test_freq 1 --nonlin wire_decom --lr 5e-3 --benchmark 
