...
test_day="240802_relu_skips2_d8w256_lr4e-4_exp_sc_batch8192"
depth="8"
width="256"
epoch="300"
...
for dataset in "${datasets[@]}"; do
    ...
    python wire_lf_new.py --data_dir "${stanford_path}/${dataset}" --exp_dir "${result_path}/${test_day}_${dataset}" --depth $depth --width $width --whole_epoch $epoch --test_freq 10 --nonlin relu_skip2 --lr 4e-4 --batch_size 8192
...
test_day="240802_relu_skips2_d4w256_lr4e-4_exp_sc_batch8192"
depth="4"
width="256"
epoch="300"
...
test_day="240802_relu_skips2_d2w256_lr4e-4_exp_sc_batch8192"
depth="2"
width="256"
epoch="300"
